    ...
    <section className="w-full py-12">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          <section className="mt-8 grid aspect-[11/8] grid-cols-10 grid-rows-10 gap-10 md:mt-0 md:aspect-[11/9]">
            <div className="relative order-1 col-start-2 col-end-6 row-start-1 row-end-9 rotate-[5deg] w-[110%] transition-all duration-200 hover:z-[99]">
              <GridItem index={1} imageSrc={WeddingImage2} />
            </div>
            <div className="relative col-start-5 col-end-9 row-start-1 row-end-9 translate-x-[5rem] rotate-[5deg] w-[110%] transition-all duration-200 hover:z-[99]">
              <GridItem index={2} imageSrc={WeddingImage1} />
            </div>
            <div className="relative col-start-3 col-end-9 row-start-5  row-end-10 h-[95%] translate-y-[2rem] transition-all duration-200 hover:z-[99]">
  ...
  return (
    ...
    >
      <Image
        ...
        alt={alt || "Hero"}
        placeholder="blur"
        className="-z-[99] h-full w-full rounded-2xl shadow-xl"
      />
