...
import { MdBusiness, MdCake, MdKeyboard, MdMusicNote } from "react-icons/md";
...
export const SERVICES: Service[] = [
  {
    icon: <FaCreditCard size={35} className=" block text-primary" />,
  ...
  {
    icon: <AiOutlineScan size={35} className=" block text-primary" />,
  ...
  {
    icon: <MdKeyboard size={35} className=" block text-primary" />,
  ...
  {
    icon: <MdCake size={35} className=" block text-primary" />,
  ...
  {
    icon: <MdBusiness size={35} className=" block text-primary" />,
